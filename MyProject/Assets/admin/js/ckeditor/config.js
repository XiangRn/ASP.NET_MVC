...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserImageBrowseUrl = '/Assets/admin/js/ckfinder/ckfinder.html?Types=Images';
	config.filebrowserFlashBrowseUrl = '/Assets/admin/js/ckfinder/ckfinder.html?Types=Flash';
